 ...
 @section('content')
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            ...
            <p>
                Contáctenos sobre cualquier inquietud relacionada con nuestra empresa o nuestros productos.
            </p>
        </div>
    </div>
    ...
    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"
     ...
     crossorigin=""></script>
    <script>
        var mymap = L.map('mapid').setView([-3.25488, -79.95394, 16], 16);
        ...
        //     maxZoom: 18,
        //     attribution: 'Gmiti | Template Design by <a href="https://gmiti.com/">Gmiti&CO</a> | Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
        ...
        L.marker([-3.25488,-79.95394, 13]).addTo(mymap)
            .bindPopup("<b>EMedicalLife</b> Matriz<br />Ubicacion.").openPopup();
